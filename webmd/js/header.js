...
var $googleloaded = $googleloaded || false;

(function () {
    /* http://fit.(*).webmd.com/, *.webmd.boots.com/ */
    var domainBlackList = [
    ...
    var notLoadGPT = domainBlackList.some(function (element, index) {
        return element.test(wmdDomain);
    });
